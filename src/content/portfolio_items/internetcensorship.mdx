...
* a homepage giving a summary of the minisite’s goals
* an individual country breakdown, displaying the specific security criteria for that country
* 3 x top ten lists showing each the countries with greatest restrictions on content, the countries with the highest amount of user rights restrictions and the countries with the top level of obstacles for access.
